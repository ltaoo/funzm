...
//     return containerElem;
   ...
   * @param range 选区范围
   */
  public getSelectionContainerElem(range?: Range) {
    let r: Range | null | undefined = range || this._currentRange;
    if (r) {
      const elem: Node = r.commonAncestorContainer;
      // get node that isn't text node.
      return isPNode(elem) ? elem : elem.parentNode;
    }
  }
   ...
   * @param range 选区范围
   */
  public getSelectionStartElem(range?: Range) {
   ...
   * @param range 选区范围
   */
  public getSelectionEndElem(range?: Range) {
    let r: Range | null | undefined;
    r = range || this._currentRange;
    let elem: Node;
    if (r) {
   ...
   * @param $node 节点
   */
  public recordSelectionNodes($node, $endElem) {
    //     let $list = [];
    //     let isEnd = true;
    //     /**
    // 	    @author:lw
