    ...
    <div className="text-left">
      <div className="flex justify-between">
        <div className="w-24 text-center">
          ...
          <div className="ml-1 text-4xl text-gray-800 dark:text-gray-300">{correct}</div>
        </div>
        <div className="w-24 text-center">
          <div className="text-md text-gray-400">错误数</div>
          <div className="ml-1 text-4xl text-gray-800 dark:text-gray-300">{incorrect}</div>
        </div>
        <div className="w-24 text-center">
          <div className="text-md text-gray-400">跳过数</div>
          <div className="ml-1 text-4xl text-gray-800 dark:text-gray-300">{skipped}</div>
        </div>
      </div>
      <hr className="mt-12" />
      <div className="mt-8 ml-5">
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 text-gray-800 dark:text-gray-300">{correctRateText}</div>
        </div>
      </div>
      <hr className="mt-8" />
      <div className="mt-8 flex flex-row-reverse">
        <span className="mr-6 text-5xl text-green-500">{score}</span>
        <span className="w-24 text-gray-800 self-end dark:text-gray-300">获得积分数</span>
      </div>
    </div>
  );
};
